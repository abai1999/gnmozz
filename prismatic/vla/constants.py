...
# RLBench-specific modality constants
FORCE_DIM = 6
FORCE_HISTORY_LEN = 32
DEPTH_TOKENS = 16
FORCE_TOKENS = 8
RLBENCH_PROPRIO_DIM = 15


# Function to detect robot platform from command line arguments
def detect_robot_platform():
    env_override = os.environ.get("VLA_PLATFORM", "").strip().upper()
    if env_override in {"LIBERO", "ALOHA", "BRIDGE", "CALVIN", "RLBENCH"}:
        return env_override
