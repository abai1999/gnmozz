...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/coarse2contact_v2/runtime_failure_traces/${MODE}_3ep}"
NAME_SUFFIX="${NAME_SUFFIX:-coarse2contact_v2_${MODE}_failure_collect_3ep}"
