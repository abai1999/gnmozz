...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/depth_force_contact/v2_assist_B_strong_ff_3ep_20260505a}"
...
exec env xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --name_suffix "v2_assist_B_strong_ff_3ep" \
  ...
  --learned_residual_scale 1.0 --max_residual_pos 0.006 --max_residual_rot 0.030 \
