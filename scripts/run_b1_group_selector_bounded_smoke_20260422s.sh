...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/eval_logs/insert_onto_square_peg/b1_group_selector_bounded_smoke_20260422s}"
export NAME_SUFFIX="${NAME_SUFFIX:-run12_b1_bounded_closeonly_applygate_smoke3}"
export EPISODE_INDICES="${EPISODE_INDICES:-1,12,17}"
