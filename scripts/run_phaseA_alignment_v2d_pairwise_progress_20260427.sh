...
OUT_ROOT="${OUT_ROOT:-$ROOT/runtime_artifacts/stage_refiner/phaseA_alignment_v2d_pairwise_progress_20260427}"
...
echo "[alignment-v2d] OUT_ROOT=$OUT_ROOT"
echo "[alignment-v2d] RECOLLECT_SUPPORT_NPZ=$RECOLLECT_SUPPORT_NPZ"
echo "[alignment-v2d] RECOLLECT_SUPPORT_NPZ_EXTRA=${RECOLLECT_SUPPORT_NPZ_EXTRA:-}"
echo "[alignment-v2d] INIT_CKPT=$INIT_CKPT"
...
cp "$STAGEB_DIR/alignment_v2_gate_report.json" "$OUT_ROOT/alignment_v2d_gate_report.json"
...
echo "[alignment-v2d] complete"
echo "[alignment-v2d] gate_report=$OUT_ROOT/alignment_v2d_gate_report.json"
echo "[alignment-v2d] deploy_candidate=$STAGEB_DIR/student_handoff_state_head_v2_alignment_v2_best_deploy_candidate.pt"
