...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/guoning/code/VLA/eval_logs/insert_onto_square_peg/truthready_positive_collect_20260420i}"
SUPPORT_DIR="${SUPPORT_DIR:-/home/guoning/code/VLA/runtime_artifacts/residual_data/insert_phase1_truthready_positive_support_20260420i}"
SUPPORT_NPZ="${SUPPORT_NPZ:-$SUPPORT_DIR/support_states.npz}"
NAME_SUFFIX="${NAME_SUFFIX:-seed3407_truthready_positive_collect}"
...
exec xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --modes pose_alignment_only_basin \
