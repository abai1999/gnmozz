...
export OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/eval_logs/insert_onto_square_peg/b1_group_selector_bounded_smoke_20260423a}"
export NAME_SUFFIX="${NAME_SUFFIX:-run12_b1_bounded_closeonly_applygate_closerich12_v4}"
export EPISODE_INDICES="${EPISODE_INDICES:-44,46,11,6,29,33,21,14,35,36,12,43}"
export NUM_EPISODES="${NUM_EPISODES:-12}"
