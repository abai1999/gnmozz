...
OUT_ROOT="${OUT_ROOT:-$ROOT/eval_logs/insert_onto_square_peg/support_rows_targeted_20260421k}"
RUN_NAME_SUFFIX="${RUN_NAME_SUFFIX:-seed3407_targeted16_shadow_v2_fixed}"
SUPPORT_NPZ="${SUPPORT_NPZ:-$ROOT/runtime_artifacts/residual_data/insert_phase1_support_targeted_learned16_20260421k/support_states.npz}"
PLAN_JSON="${PLAN_JSON:-$ROOT/runtime_artifacts/residual_data/insert_phase1_targeted_recollect_20260421k/targeted_recollection_plan.json}"
...
p = Path("/home/guoning/code/VLA/runtime_artifacts/residual_data/insert_phase1_targeted_recollect_20260421k/targeted_recollection_plan.json")
...
echo "[targeted_collect] episode_indices=${EPISODE_INDICES}"
echo "[targeted_collect] support_npz=${SUPPORT_NPZ}"
