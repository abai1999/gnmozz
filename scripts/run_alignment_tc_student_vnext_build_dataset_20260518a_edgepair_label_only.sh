...
TAG="${TAG:-20260518a_edgepair_label_only}"

PHASE1_BASE_RAW="${PHASE1_BASE_RAW:-$ROOT/runtime_artifacts/alignment_tc_diffusion/alignment_tc_planner_state_expert_recovery_raw_20260514n_zonly80_fixed_merged_raw.npz}"
PHASE1_LABEL_RAW="${PHASE1_LABEL_RAW:-$ROOT/runtime_artifacts/alignment_tc_diffusion/privileged_teacher_raw_20260518a_edgepair_label_only_phase1/alignment_tc_privileged_teacher_raw_20260518a_edgepair_label_only_phase1.npz}"
...
"$PYTHON_BIN" "$ROOT/scripts/build_alignment_tc_student_vnext_dataset.py" \
  --phase1_raw "$PHASE1_BASE_RAW" "$PHASE1_LABEL_RAW" \
