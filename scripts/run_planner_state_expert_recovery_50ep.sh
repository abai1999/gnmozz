...
EPISODE_COUNT="${EPISODE_COUNT:-50}"
MAX_STEPS="${MAX_STEPS:-360}"
VIDEO_EPISODES="${VIDEO_EPISODES:-10}"
TAG="${TAG:-20260514e_50ep}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT/runtime_artifacts/alignment_tc_diffusion/planner_state_expert_recovery_${TAG}}"
...
RAW_OUTPUT_NPZ="${RAW_OUTPUT_NPZ:-$OUTPUT_DIR/alignment_tc_planner_state_expert_recovery_raw_${TAG}.npz}"
REPORT_JSON="${REPORT_JSON:-$OUTPUT_DIR/report_${TAG}.json}"
