...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT/runtime_artifacts/stage_refiner/student_handoff_state_v2_phaseA_ready_neighborhood_20260423q/train_ready_neighborhood_small}"
...
python "$ROOT/scripts/train_student_handoff_state_head_v2.py" \
  ...
  --lambda_ready_neighborhood_consistency 0.20 \
  --ready_neighborhood_target_logit 0.0 \
  --ready_pos_margin_logit 1.05 \
...
echo "[phaseA-ready-neighborhood-consistency] output_dir=$OUTPUT_DIR"
