...
B2_CANDIDATE_CKPT="${B2_CANDIDATE_CKPT:-$ROOT/runtime_artifacts/stage_refiner/b2_yawmode_dataset_v13_selected_profile_20260425c/runtime_summary_mode_v14c_runtimeyaw_20260425d/student_candidate_evaluator_v2_v14c_runtime_summary_mode.pt}"

OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/eval_logs/insert_onto_square_peg/b2_candidate_shadow_v14d_20260425e}"
NAME_SUFFIX="${NAME_SUFFIX:-b2_v14d_runtimeyaw_shadow_nearish_keepbaseline}"
...
B2_SHADOW_GATE_MODE="${B2_SHADOW_GATE_MODE:-nearish_only}"
