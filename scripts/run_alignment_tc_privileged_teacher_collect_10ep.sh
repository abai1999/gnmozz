...
env xvfb-run -a "$PYTHON_BIN" "$ROOT/scripts/evaluate_rlbench.py" \
  ...
  --alignment_tc_teacher_k_xy 0.20 \
  --alignment_tc_teacher_k_z 0.14 \
  --alignment_tc_teacher_k_yaw 0.12 \
  ...
  --alignment_tc_teacher_broad_max_yaw_step 0.018 \
  --alignment_tc_teacher_near_max_pos_step 0.0030 \
  --alignment_tc_teacher_near_max_yaw_step 0.012 \
  --alignment_tc_teacher_micro_max_pos_step 0.0015 \
  --alignment_tc_teacher_micro_max_yaw_step 0.008 \
  ...
  --alignment_tc_teacher_micro_min_pos_step 0.0007 \
