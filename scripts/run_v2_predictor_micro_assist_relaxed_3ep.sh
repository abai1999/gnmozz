...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/depth_force_contact/v2_predictor_micro_assist_relaxed_3ep_20260506a}"
...
exec env xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --name_suffix "v2_predictor_micro_assist_relaxed_3ep" \
