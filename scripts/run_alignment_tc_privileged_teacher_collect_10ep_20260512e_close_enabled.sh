...
TAG="${TAG:-20260512e_close_enabled_10ep}"
...
env xvfb-run -a "$PYTHON_BIN" "$ROOT/scripts/evaluate_rlbench.py" \
  ...
  --alignment_tc_teacher_k_xy 0.24 \
  --alignment_tc_teacher_k_z 0.11 \
  --alignment_tc_teacher_k_yaw 0.08 \
  --alignment_tc_teacher_max_pos_step 0.0018 \
  --alignment_tc_teacher_max_yaw_step 0.006 \
  --alignment_tc_teacher_broad_max_pos_step 0.0045 \
  --alignment_tc_teacher_broad_max_yaw_step 0.016 \
  --alignment_tc_teacher_near_max_pos_step 0.0030 \
  --alignment_tc_teacher_near_max_yaw_step 0.010 \
  --alignment_tc_teacher_micro_max_pos_step 0.0016 \
  --alignment_tc_teacher_micro_max_yaw_step 0.006 \
  ...
  --alignment_tc_teacher_broad_min_pos_step 0.0018 \
  --alignment_tc_teacher_near_min_pos_step 0.0015 \
  --alignment_tc_teacher_micro_min_pos_step 0.0009 \
  --alignment_tc_teacher_no_invert_yaw_control \
  --teacher_no_planner_close_handoff \
  --teacher_close_xy_threshold 0.012 \
  --teacher_close_abs_z_threshold 0.025 \
  --teacher_close_yaw_threshold 0.12 \
  --teacher_verify_hold_steps 8 \
  --teacher_verify_lift_threshold 0.012 \
  --teacher_verify_follow_distance 0.060 \
