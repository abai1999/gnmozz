...
HANDOFF_PROVIDER_CKPT="${HANDOFF_PROVIDER_CKPT:-$ROOT/runtime_artifacts/stage_refiner/student_handoff_state_v2_phaseA_overlapfix_crossing_20260423h/train_overlapfix_crossing_small/student_handoff_state_head_v2_best_ready.pt}"

OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/eval_logs/insert_onto_square_peg/phaseA_overlap_applied_smoke_20260423i}"
NAME_SUFFIX="${NAME_SUFFIX:-overlapfix_crossing_applied_ep011_ep014}"
