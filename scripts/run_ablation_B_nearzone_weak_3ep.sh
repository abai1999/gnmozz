...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/depth_force_contact/ablation_B_nearzone_weak_3ep_20260504a}"
...
exec env xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --name_suffix "depth_force_local_proposal_ablation_B_nearzone_weak_3ep" \
