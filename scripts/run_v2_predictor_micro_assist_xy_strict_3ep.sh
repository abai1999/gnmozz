...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/depth_force_contact/v2_predictor_micro_assist_xy_strict_3ep_20260506b}"
...
exec env xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --name_suffix "v2_predictor_micro_assist_xy_strict_3ep" \
  ...
  --alignment_near_zone_xy_threshold 0.03 --alignment_near_zone_z_threshold 0.10 \
