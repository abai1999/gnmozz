...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/depth_force_contact/alignment_v3_from_scratch_runtime_shadow_3ep_20260507a}"
...
ALIGNMENT_V3_SHADOW_CKPT="${ALIGNMENT_V3_SHADOW_CKPT:-$ROOT/runtime_artifacts/depth_force_contact/alignment_v3_from_scratch_formal_run1_20260507a/alignment_v3_direct_local_best.pt}"
...
exec env xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --name_suffix "alignment_v3_from_scratch_runtime_shadow_3ep" \
