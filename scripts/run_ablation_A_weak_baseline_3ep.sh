...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/depth_force_contact/ablation_A_weak_baseline_3ep_20260504a}"
...
exec env xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --name_suffix "depth_force_local_proposal_ablation_A_weak_baseline_3ep" \
