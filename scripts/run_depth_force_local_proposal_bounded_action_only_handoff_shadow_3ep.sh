...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/runtime_artifacts/depth_force_contact/bounded_action_only_handoff_shadow_3ep_20260504a}"
...
exec env xvfb-run -a "$PYTHON_BIN" scripts/evaluate_rlbench_modes.py \
  ...
  --name_suffix "depth_force_local_proposal_final_full_bounded_action_only_handoff_shadow_3ep" \
