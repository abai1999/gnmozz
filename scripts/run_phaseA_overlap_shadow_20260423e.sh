...
HANDOFF_PROVIDER_CKPT="${HANDOFF_PROVIDER_CKPT:-$ROOT/runtime_artifacts/stage_refiner/student_handoff_state_v2_phaseA_overlapfix_20260423d/train_overlapfix_small/student_handoff_state_head_v2_best_phaseA_deploy.pt}"

OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/eval_logs/insert_onto_square_peg/phaseA_overlap_shadow_20260423e}"
NAME_SUFFIX="${NAME_SUFFIX:-overlapfix_ep011_ep014}"
